...
public class SingleTimestepRegressionExample {
    ...
    public static  void main(String[] args) throws Exception {
        ...
        String path = "/home/lisztian/MDFA-Learning/src/main/resources/rnnRegression";
        int miniBatchSize = 32;

        // ----- Load the training data -----
        SequenceRecordReader trainReader = new CSVSequenceRecordReader(0, ";");
        trainReader.initialize(new NumberedFileInputSplit(path + "/passengers_train_%d.csv", 0, 0));
        ...
        testReader.initialize(new NumberedFileInputSplit(path + "/passengers_test_%d.csv", 0, 0));
